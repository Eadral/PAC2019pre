...
inline void Clear(RDouble4D dqdx_4d, int i_start, int i_end, int i_length, int j_start, int j_end, int j_length, int k_start, int k_end, int k_length, int m_start, int m_end, int m_length);
...
int main()
{
	...
	for (int nsurf = 1; nsurf <= THREE_D; ++nsurf)
	{
		...
		int m_start = M.first() - MW.first();  int m_end = M.last() - MW.first() + 1; int m_length = M.length() - MW.first() + 1;
		...
		Clear(dqdx_4d, i_start, i_end, i_length, j_start, j_end, j_length, k_start, k_end, k_length, m_start, m_end,
			m_length);
		Clear(dqdy_4d, i_start, i_end, i_length, j_start, j_end, j_length, k_start, k_end, k_length, m_start, m_end,
			m_length);
